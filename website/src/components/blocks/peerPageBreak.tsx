...
// import {pxToRem, whenMobile} from 'styles/helpers'
...
export function PageBreakBlock({
  ...
  return (
    <div
    // className={css(PeerPageBreakStyle)}
    >
      <div
      // className={css(PeerPageBreakInnerStyle)}
      >
        {peer && (
          <div
          // className={css(PeerPageBreakImageStyle)}
          >
        ...
        <p
        // className={css(PeerPageBreakTextStyle)}
        >
          {text}
        </p>
        {linkText && linkURL && (
          // <Link
          // className={css(PeerPageBreakButton)}
          // href={linkURL}>
