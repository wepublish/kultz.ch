...
export function ListicalBLock({listical}: ListicalBLockProps) {
  ...
  return (
    <div
      ref={ref}
      // className={css(ListicalWrapperStyle)}
    >
      {listical.map((item, index) => (
        <div
          key={index}
          // className={css(ListicalItemStyle)}
        >
          <div
          // className={css(ListicalItemInnerStyle)}
          >
            <div
            // className={css(ListicalNumberStyle)}
            >
              {index + 1}
            </div>
            <h2
            // className={css(ListicalTitleStyle)}
            >
              {item.title}
            </h2>
            {item.image && (
              <div
              // className={css(ListicalImageStyle)}
              >
                <RatioImage
            ...
            {item.text && (
              <div
              // className={css(ListicalTextStyle)}
              >
