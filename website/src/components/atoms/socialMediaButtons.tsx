...
import {pxToRem, whenDesktop, whenMobile, whenTablet} from '../../../styles/helpers'
...
export function MobileSocialMediaButtons({shareUrl: fbShareUrl}: SocialMediaButtonsProps) {
  ...
  return (
    <div
    // className={css(MobileStyle)}
    >
      <span
      // className={css(MobileLinkStyle)}
      >
        {/* <Link
          target="_blank"
          rel="noopener"
...
export function DesktopSocialMediaButtons({shareUrl: fbShareUrl}: SocialMediaButtonsProps) {
  ...
  return (
    <div
    // className={css(DesktopStyle)}
    >
      <div
      // className={css(DesktopInnerStyle)}
      >
        <span
        // className={css(DesktopLinkStyle)}
        >
          {/* <Link
            target="_blank"
            rel="noopener"
